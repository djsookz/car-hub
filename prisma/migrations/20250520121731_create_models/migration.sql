...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'CarHub',
    "address" TEXT NOT NULL DEFAULT 'Tsar Ivan Asen II no. 4, Pazardzhik, Bulgaria',
    "phone" TEXT NOT NULL DEFAULT '+359 8851919 76',
    "email" TEXT NOT NULL DEFAULT 'djdimcho25@gmail.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
