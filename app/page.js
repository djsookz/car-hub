    ...
    <div className="pt-20 flex flex-col" >
      ...
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">Find your Dream Car with CarHub AI</h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            ...
            <div className="h-16 w-auto mx-auto mb-2 relative">
              <Image src={make.image} alt={make.name} fill sizes="full" style={{objectFit:"contain"}}/>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Book a test drive online in minutes, with flexible schedling options.
              </p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 text-blue-700 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4  gap-4">
            ...
            <div className="overflow-hidden rounded-lg flex justify-end h-28 mb-4 relative">
              <Image src={type.image} alt={type.name} fill sizes="100%" className="object-cover group-hover:scale-105 transition duration-300"/>
            </div>
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent rounded-lg flex items-end">
              <h3 className="text-white text-xl font-bold pl-4 pb-0">{type.name}</h3>
            </div>
            </Link>
            ))}
          </div>
